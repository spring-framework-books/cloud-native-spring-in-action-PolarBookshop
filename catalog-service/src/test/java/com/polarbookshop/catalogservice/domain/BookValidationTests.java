...
/*
 *  In the Catalog Service application, a good candidate for unit testing might be
 *  the validation logic for the Book class. The validation constraints are defined using the
 *  Java Validation API annotations, and we are interested in testing that they are applied
 *  correctly to the Book class
 */
